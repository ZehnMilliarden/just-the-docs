...
See [the Code documentation]({% link _tests/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link _tests/navigation-structure.md %}#external-navigation-links) for more details.
...
See [Customization]({% link _tests/customization.md %}) for more information.
...
See [Callouts]({% link _tests/ui-components/callouts.md %}) for more information.
